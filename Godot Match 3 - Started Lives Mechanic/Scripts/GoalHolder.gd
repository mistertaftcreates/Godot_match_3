...
"""
The goal holder should do only that: Hold the goals.
I've got it doing too many things here.  The signal for
knowing if the game was won or lost should be in the 
Game Manager, not this node.
"""
"""
signal create_goal
signal game_won
...
#this logic should be in the game manager
func check_game_win():
	if goals_met():
