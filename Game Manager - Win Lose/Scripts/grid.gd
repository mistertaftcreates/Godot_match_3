...
""" 
This is a grid script.  It creates and manages the 
game pieces on the board and sends information about 
what move the game is on to the game manager and other
observers in the scene.  
"""
...
func spawn_sinkers(number_to_spawn):
	for i in number_to_spawn:
		...
		var rand_piece = floor(rand_range(0, 2))
